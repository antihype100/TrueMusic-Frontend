...
const ProfileInfo = ({authorName}: IAuthorInfo) => {
  ...
  return (
    <section className={styles.wrapper}>
      ...
      {author ? <Setting/> : <Link to={`/author/${authorName}/authorMainPage`} className={styles.linkMainPage}>Перейти на главную страницу автора</Link>}
    </section>
  );
};
